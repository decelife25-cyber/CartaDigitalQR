      ...
      <div className="absolute inset-x-0 bottom-0 z-10 px-5 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-20">
        <div className="mx-auto flex w-full max-w-md flex-col gap-2.5">
          <button
            ...
            className="flex h-14 w-full items-center justify-center gap-2 rounded-2xl bg-white/95 px-5 text-base font-extrabold text-slate-900 shadow-xl backdrop-blur active:scale-[.99]"
          >
          ...
          <button
            ...
            className="flex h-14 w-full items-center justify-center gap-2 rounded-2xl bg-[var(--color-primary)] px-5 text-base font-extrabold text-white shadow-xl backdrop-blur active:scale-[.99]"
          >
          ...
          <button
            type="button"
            onClick={() => phone ? (window.location.href = `tel:${phone}`) : undefined}
            className="flex h-14 w-full items-center justify-center gap-2 rounded-2xl border border-white/70 bg-black/35 px-5 text-base font-extrabold text-white shadow-xl backdrop-blur active:scale-[.99]"
          >
